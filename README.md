...
| [`systems-and-security`](skills/systems-and-security/) | Bash/Linux, PowerShell/Windows, and scoped security assessment | 55 | 483 | 1,274 |
...
- [`marketing-and-growth`](skills/marketing-and-growth/): Develop evidence-based marketing, pricing, growth, positioning, conversion, and fundraising. Use for market research, product marketing, pricing tiers, plans, or packages, SEO, acquisition, lifecycle, monetization, copy, ads, or investor communications; exclude visual design, office documents, and software implementation.
