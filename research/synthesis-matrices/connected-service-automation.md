...
| Identity | Resolve service, account, tenant, workspace, device, recipient, channel, timing, and resource explicitly | Ambiguity is a hard stop before a write; tool availability does not justify service or target substitution |
