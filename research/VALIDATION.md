...
- Token counts: generated for every active skill with `cl100k_base` under pinned `tiktoken==0.11.0`; README description/core/full figures match the generated record. Description counts measure the always-loaded front-matter value and total 580 tokens across the 10-skill suite. The per-hash [source description-token record](source-description-token-counts.csv) binds the 5,613-token comparison and collision-free benchmark installation name to all 119 active retained hashes; it was generated from the exact reconstructed corpus without committing source prose.
...
- Checker checksum: `4bb17741498063cceec426252ab19e21fc00651283cb5df9a9bd79db119e85a5`.
...
list of 999 content hashes. The checker independently computes the Git blob ID
of every external file and rejects missing, unexpected, or duplicate blobs
...
The 999-entry gate is complete. The dependency-closure comparison remains a
...
run with `--closure-sources`, and its emitted closure count and checksum must
